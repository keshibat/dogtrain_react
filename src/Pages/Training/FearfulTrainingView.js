      ...
      <>
            ...
            <div className="column">
              <article className="message is-info">
                <div className="message-header listheader">
                  <p className="title has-text-centered">A fearful dog may run or he may hide - either way we want him to become comfortabe and confident wherever he is.</p>
                </div>
                ...
                <div className="message-body">
                  <div className="content is-primary">
                    <ul>
                      ...
                      <li className="subtitle">Mechanical sounds (lawn mowers, vacuum cleaners, motorbikes)</li>
                    </ul>
                  </div>
                </div>
              </article>
                ...
                <div className="message-body">
                  <div className="content is-primary">
                    <ul>
                      ...
                      <li className="subtitle">Car travel(car sickness, over-protectiveness of car Grooming)</li>
        ...
        <section className="hero">
          <div className="hero-body">
            <div className="container">
              <h1 className="title has-text-centered">
                Fear aggression, separation anxiety, chewing, digging, crying and howling are some of the many things
                that can be resolved with in-home dog training
              </h1>
              <br />
        ...
        <section className="quotes" >
          ...
          <div className="columns">
            <div className="column">
              <article className="message is-primary is-medium quote">
                <div className="message-body">
                  ...
                  <br />
                    Fiona and I want to extend our warm thanks and gratitude for your help with training Peggy (and us!).
                    As you know Peggy (the 2½ year old Fox Terrier X) caused us some concern when we first rescued her.
                    We found her rather timid and submissive and we were troubled by her jumping up, mouthing, and some other undesirable behaviours.
            ...
            <div className="column">
              <article className="message is-primary is-medium quote">
                <div className="message-body">
                   We now have a dog that is much more confident and obedient, primarily because we are more confident and consistent with her.
                   We feel that we have managed to achieve these results because you were able to quickly identify the remedial action that was needed and give us clear and easy to apply instructions.  Once again, very many thanks and we would recommend you and your approach to anyone seeking help with training their dog.
                    <br />
                  Kind regards
                  <br />
                  <strong>Ian</strong>
