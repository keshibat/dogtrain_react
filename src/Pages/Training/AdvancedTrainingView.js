      ...
      <>
        ...
        <section className="has-background-light">
          <div className="columns">
            ...
            <div className="column">
              <article className="message is-info">
                <div className="message-header listheader">
                  <p className="title has-text-centered">Here are some ideas of what our dog training service can help you with:</p>
                </div>
                <div className="message-body">
                  <div className="content is-primary">
                    <ul>
                      <li className="subtitle">Off-leash walking at “Heel”</li>
                      <li className="subtitle">Come from a distance</li>
                      <li className="subtitle">Distance control (sit, drop, stay)</li>
                      <li className="subtitle">Clicker training and targeting</li>
                    </ul>
                  </div>
                </div>
              </article>
            ...
            <div className="column">
              <article className="message is-info">
                <div className="message-header listheader">
                  <p className="title has-text-centered">Trick training can include:</p>
                </div>
                <div className="message-body">
                  <div className="content is-primary">
                    <ul>
        ...
        <section className="hero">
          <div className="hero-body">
            <div className="container">
              <h1 className="title has-text-centered">
                Dog obedience is great, advanced dog obedience is better.  And trick training is a fantastic and fun way for both children and adults to interact with their pets
              </h1>
              <br />
          ...
          <div className="columns">
            <div className="column">
              <article className="message is-primary is-medium quote">
                <div className="message-body">
                    This is a huge THANK YOU for all your help and advice with our dear little Nala.
                    We have seen such a huge change in her (more so us?!) after your visits.
