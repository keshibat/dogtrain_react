        ...
        <section className="has-background-light">
          ...
          <div className="columns">
            <div className="column">
              <article className="message is-info">
                <div className="message-header listheader">
                  <p className="title has-text-centered">Dogs, cats (and kids!) are all trainable - aim for harmony in your home</p>
                </div>
            ...
            <div className="column">
              <article className="message is-info">
                <div className="message-header listheader">
                  <p className="title has-text-centered">A dog who has often been the substitute child now has to deal with a lot of changes.</p>
                </div>
                <div className="message-body">
                  <div className="content is-primary">
                    <ul>
                      <li className="subtitle">Setting or changing rules or boundaries</li>
                      <li className="subtitle">Introducing the new family member</li>
                      <li className="subtitle">Interacting with the new family member – what’s appropriate and what’s not!</li>
                    </ul>
                  </div>
                </div>
              </article>
            ...
            <div className="column">
              <article className="message is-info">
                <div className="message-header listheader">
                  <p className="title has-text-centered">To minimise the stress for all, our in home dog training can cover:</p>
                </div>
                <div className="message-body">
                  <div className="content is-primary">
                    <ul>
                      <li className="subtitle">Settle (to remain in one spot)</li>
                      <li className="subtitle">Wait at doors/gates/etc rather than charging through</li>
                      <li className="subtitle">Walking well with pram/child/another dog</li>
                    </ul>
                  </div>
                </div>
              </article>
          ...
          <div className="columns">
            <div className="column">
              <article className="message is-primary is-medium quote">
                <div className="message-body">
                  After La bit my friend, and started becoming snappy with small children,
                  I knew something had to be done. Your lessons with she and I have made a world of difference.
