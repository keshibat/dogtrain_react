        ...
        <section className="has-background-light">
          ...
          <div className="columns">
            <div className="column">
              <article className="message is-info">
                <div className="message-header listheader">
                  <p className="title has-text-centered">Let us help you make your rescue dog's home his 'forever home'</p>
                </div>
            ...
            <div className="column">
              <article className="message is-info">
                <div className="message-header listheader">
                  <p className="title has-text-centered">Using this gentle, confidence-building technique with our Adopted Dog Training we can help with:</p>
                </div>
                <div className="message-body">
                  <div className="content is-primary">
                    <ul>
                      <li className="subtitle">Resolving trauma from past ‘lives’ eg. fears and phobias</li>
                      <li className="subtitle">Rehabilitating rescued/re-homed dogs</li>
                      <li className="subtitle">Toilet training</li>
                      <li className="subtitle">Establishing good dog manners in the home</li>
            ...
            <div className="column">
              <article className="message is-info">
                <div className="message-header listheader">
                  <p className="title has-text-centered">Free follow-up email and telephone rescued dog training support available</p>
                </div>
                <div className="message-body">
                  <div className="content is-primary">
                    <ul>
                      ...
                      <li className="subtitle">Insecurity based behaviours</li>
                      <li className="subtitle">Separation issues (barking, crying, scratching doors, howling)</li>
          ...
          <div className="columns">
            <div className="column">
              <article className="message is-primary is-medium quote">
                <div className="message-body">
                  As you know Muttley had become a pain that I nearly had him put to sleep because of his behaviour, biting, digging holes,
                  being aggressive to the other 2 dogs and generally becoming unacceptable. With your guidance,
                  Muttley has now become a good member of our household. Behaving himself, doing as he is told when he is told, being able to groom him, no biting and becoming a little darling.
            ...
            <div className="column">
              <article className="message is-info is-medium quote">
                <div className="message-body">
                  ...
                  <br />
                  1.
                  erocious stance and barking when anyone came to the front door. This would continue for a few minutes, until she was able to satisfy herself that the visitors weren’t going to hurt her
                  <br />
