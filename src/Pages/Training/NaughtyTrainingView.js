      ...
      <>
            ...
            <div className="column">
              <article className="message is-info">
                <div className="message-header listheader">
                  <p className="title has-text-centered">You can have the dog as he naturally is, or you can help him to be the dog you want...</p>
                </div>
                ...
                <div className="message-body">
                  <div className="content is-primary">
                    <ul>
                      ...
                      <li className="subtitle">Aggression to other dogs or people</li>
                      ...
                      <li className="subtitle">Integration with other pets – cat, rabbit, ferret...</li>
                    </ul>
                  </div>
                </div>
              </article>
            ...
            <div className="column">
              <article className="message is-info">
                ...
                <div className="message-body">
                  <div className="content is-primary">
                    <ul>
                        <li className="subtitle">Destruction/destroying the garden or items </li>
                        <li className="subtitle">Attention seeking/being demanding</li>
                        <li className="subtitle">Toilet training/Toileting in one spo</li>
                        <li className="subtitle">Pulling washing off the line</li>
                        <li className="subtitle">Chasing bikes, joggers, cars, skateboards, motorbikes, etc</li>
                        <li className="subtitle">Mouthing and nipping</li>
                        <li className="subtitle">Rough play (with people or other dogs)</li>
                      <li className="subtitle">Obsessive/compulsive behaviour – licking, tail chasing, etc</li>
                    </ul>
                  </div>
                </div>
              </article>
        ...
        <section className="hero">
          <div className="hero-body">
            <div className="container">
              <h1 className="title has-text-centered">
                Resolve separation anxiety, pulling on leash, dog aggression, jumping up, digging, chewing, destruction and much.
              </h1>
              <br />
              <h2 className="subtitle has-text-centered">
            ...
            <div className="column">
              <article className="message is-primary is-medium quote">
                <div className="message-body">
                  ...
                  Having traumatic beginnings early in his life,
                  Ben proved to be of a stronger character than the normal large breed.
            ...
            <div className="column">
              <article className="message is-info is-medium quote">
                <div className="message-body">
                  ...
                  Before your wonderful dog obedience training, we were the ones sitting and fetching.
                  The change in him is unbelievable. He's transformed from a monster to an angel.
                  Keep up the fabulous work and Ralph would like to give you a big lick and a tail wag.
                  Thanks again.
                  <br />
