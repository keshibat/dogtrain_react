            ...
            <div className="columns is-centered">
              ...
              <div className="column">
                <div className="content">
                  ...
                  <p>
                    Although Maria had done obedience training with the family’s
                    dogs throughout her childhood, her intense involvement in
                    the training of horses in the 1980s taught her the skills
                    that are now considered ‘revolutionary’ in the dog training
                    world – motivational training. This is also where "Dog
                    Whispering" first started.
                  </p>
                  <p>
                    Through her ongoing study of dogs, dog training methods, dog
                    behaviour, dog desensitisation techniques, and other
                    ...
                    the harsh methods previously used in dog and puppy training,
                    instead giving owners a new insight into their dogs.
                  </p>
                  <p>
